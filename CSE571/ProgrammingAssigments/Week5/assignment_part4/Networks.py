...
# custom architecture
        ...
        # self.hidden_layer_2 = nn.Linear(36, 6)
        # self.hidden_layer_3 = nn.Linear(6, 3)
...
# and return the output which should be a tensor
        hidden = self.relu(self.hidden_layer(network_input))
...
# output and the desired output.
        ...
        for _, sample in enumerate(test_loader):
            model_output = model.forward(torch.tensor(sample['input'], dtype=torch.float32))
