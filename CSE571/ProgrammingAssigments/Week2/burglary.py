...
def buildBN():
    ...
    burglary_model.add_cpds(cpd_burglary,
                            cpd_earthquake,
                            cpd_alarm,
                            cpd_johncalls,
                            cpd_marycalls)

    # burglary_model.check_model()
    # for cpd in burglary_model.get_cpds():
    ...
    # # a
    # print(burglary_infer.query(variables=['JohnCalls'], evidence={'Earthquake': 0}))
    # # b
    # print(burglary_infer.query(variables=['MaryCalls'], evidence={'Burglary': 1, 'Earthquake': 0}))
    # # c
    # print(burglary_infer.query(variables=['MaryCalls'], evidence={'Burglary': 1, 'Earthquake': 1}))
    # # d
    # print(burglary_infer.query(variables=['MaryCalls'], evidence={'JohnCalls': 1}))
    # # e
    # print(burglary_infer.query(variables=['MaryCalls'], evidence={'JohnCalls': 1, 'Burglary': 0, 'Earthquake': 0}))
