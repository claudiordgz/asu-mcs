...
int main(int argc, char* argv[]) {
    ...
    struct page_table* pt_fifo = page_table_create(data->page_count, data->frame_count, FIFO, verbose);
    struct page_table* pt_lru = page_table_create(data->page_count, data->frame_count, LRU, verbose);
    struct page_table* pt_mfu = page_table_create(data->page_count, data->frame_count, MFU, verbose);
